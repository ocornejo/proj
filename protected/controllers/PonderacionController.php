...
class PonderacionController extends Controller
{
	 ...
	 * @return Ponderacion the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Ponderacion::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Ponderacion $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ponderacion-form')
		{
